...
export const CONCIERGE={
  ...
  // Савва — мужское имя, и голос должен быть мужской. Раньше здесь стояла
  // alena: это голос Алисы, из-за чего наш консьерж звучал как чужой продукт.
  // filipp в SpeechKit описан как уверенный мужской — ровно то, что нужно
  // человеку, который говорит «идите сюда» и не уговаривает.
  voice:"filipp",
  traits:[
