...
const CATEGORIES=[
  ...
  {tag:"bar",re:new RegExp(`${B}(бар(?!бер|аба|бек|он|ин|сук|рикад|окко|вих|хат|селон|ан|ьер|мен|ж|д)|паб(?!лик)|пив[ао]|вин[оа]${E}|винн|винотек)|(?<![a-z])pub(?!li)|выпить|коктейл|алкогол|дринк`),
